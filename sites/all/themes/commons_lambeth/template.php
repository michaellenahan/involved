 ...
 * 1. Rename each function and instance of "commons_lambeth" to match
 ...
 */
function commons_lambeth_preprocess_html(&$vars) {
  global $theme_key;
...
function commons_lambeth_process_html(&$vars) {
}
// */
 ...
 */
function commons_lambeth_menu_link($vars) {
  $output = '';
  ...
  commons_lambeth_menu_link_class($element);
  $sub_menu = '';
 ...
 */
function commons_lambeth_menu_link_class(&$element)  {
 ...
 */
function commons_lambeth_preprocess_page(&$vars) {
...
function commons_lambeth_process_page(&$vars) {
}
// */
 ...
 */
function commons_lambeth_preprocess_node(&$vars) {
  // dpm($vars);
...
function commons_lambeth_process_node(&$vars) {
}
// */
...
function commons_lambeth_preprocess_comment(&$vars) {
}
function commons_lambeth_process_comment(&$vars) {
}
// */
 ...
 */
/* -- Delete this line if you want to use these functions
function commons_lambeth_preprocess_block(&$vars) {
}
function commons_lambeth_process_block(&$vars) {
}
// */
