...
<?php print $styles; ?>
<link rel="stylesheet" href="<?php print base_path() . drupal_get_path('theme', 'commons_lambeth'); ?>/css/global.base.css">
<link rel="stylesheet" href="<?php print base_path() . drupal_get_path('theme', 'commons_lambeth'); ?>/css/global.styles.css">
<?php print $scripts; ?>
<?php print $polyfills; ?>
</head>
